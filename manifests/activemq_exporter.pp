...
#
# This module manages prometheus activemq_exporter
#
# Parameters:
#  [*arch*]
...
#
#  [*cnf_scrape_uri*]
#  The URI to obtain Logstash stats from
#
#  [*download_extension*]
...
class prometheus::activemq_exporter(
  ...
  Optional[String] $download_url = 'https://repo1.maven.org/maven2/io/prometheus/jmx/jmx_prometheus_javaagent/0.12.0/jmx_prometheus_javaagent-0.12.0.jar',
  String $arch                   = $prometheus::real_arch,
  Stdlib::Absolutepath $bin_dir  = $prometheus::bin_dir,
  Boolean $export_scrape_job     = false,
  Stdlib::Port $scrape_port      = 8184,
  String[1] $scrape_job_name     = 'activemq',
) inherits prometheus {
